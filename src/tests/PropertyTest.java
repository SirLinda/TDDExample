...
class PropertyTest
{
    ...
    void setUp()
    {
        ...
        property1 = new Property(499000.0, address, 1, true, "resiDEnce", "11111");
        property2 = new Property(1000000.0, address, 2, false, "commErcial", "22222");
        property3 = new Property(840000.0, address, 3, false, "rETAil", "xxxxx");
    }
    ...
    void getExpectedExceptionsAddress()
    {
        NullPointerException ex = assertThrows(NullPointerException.class, ()->{
            property1 = new Property(499000.0, null, 1, true, "residence", "11111");
        });
    ...
    {
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, ()->{
            property1 = new Property(499000.0, address, 0, true, "residence", "11111");
        });
        assertTrue(ex.getMessage().equals("Invalid number of bedrooms: 0"));

        ex = assertThrows(IllegalArgumentException.class, ()->{
            property1 = new Property(499000.0, address, 21, true, "residence", "11111");
        });
    ...
    {
        NullPointerException ex = assertThrows(NullPointerException.class, ()->{
            property1 = new Property(499000.0, address, 1, true, null, "11111");
        });
        assertTrue(ex.getMessage().equals("Invalid property type: null"));

        IllegalArgumentException ex2 = assertThrows(IllegalArgumentException.class, ()->{
            property1 = new Property(499000.0, address, 2, true, "residencee", "11111");
        });
    ...
    {
        NullPointerException ex = assertThrows(NullPointerException.class, ()->{
            property1 = new Property(499000.0, address, 1, true, "residence", null);
        });
        assertTrue(ex.getMessage().equals("Invalid property id: null"));


        IllegalArgumentException ex2 = assertThrows(IllegalArgumentException.class, ()->{
            property1 = new Property(499000.0, address, 1, true, "residence", "");
        });
        assertTrue(ex2.getMessage().equals("Invalid property id: "));

        ex2 = assertThrows(IllegalArgumentException.class, ()->{
            property1 = new Property(499000.0, address, 1, true, "residence", "1234567");
        });
